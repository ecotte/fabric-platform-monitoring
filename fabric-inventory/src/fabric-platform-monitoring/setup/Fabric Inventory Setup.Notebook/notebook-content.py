...
# - The service principal must also be a **Member of the workspace** where the Fabric Inventory solution is deployed.
# 
...
# - ✔️ Service principal is a **Member of the Fabric Inventory workspace**
