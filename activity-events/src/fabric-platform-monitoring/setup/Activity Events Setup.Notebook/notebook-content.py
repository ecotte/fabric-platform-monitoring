...
# # ✅ Prerequisites for Activity Events & Fabric Admin API
# 
# This document outlines the required setup to successfully run the **Activity Events** process using the **Microsoft Fabric Admin API**.
# 
# ---
# 
...
# 
# The **user or identity executing the Activity Events process** must have permission to read secrets from the Key Vault.
# 
...
# 
# - Enable the **pipeline schedule** associated with the Activity Events process
...
# 
# 🚀 Once completed, the Activity Events process will run automatically as scheduled.
